...
$emaildestinatario = 'caiquegomessouza@gmail.com'; // Digite seu e-mail aqui, lembrando que este arquivo deve estar em seu servidor web
$cel= $_POST['cel'];
$res= $_POST['res'];
...
$mensagemHTML = '<P>FORMULARIO PREENCHIDO NA SUA TROCA DE EPI</P>
